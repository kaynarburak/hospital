...
5	2022-12-28	13:00:00	5	f	1
6	2022-12-28	13:30:00	9	f	1
...
SELECT pg_catalog.setval('public.hasta_hasta_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.kullanici_kullanici_id_seq', 6, true);
